...
public class ManageItemFormController {
    ...
    public void initialize(){
        ...
        try {
            tblItems.getItems().addAll(ItemData.getAllItems());
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            if (btnSave.getText().equals("SAVE")) {
                if (ItemData.existsItem(item.getCode())) {
    ...
    public void btnDelete_OnAction(ActionEvent actionEvent) {
        Item selectedItem = tblItems.getSelectionModel().getSelectedItem();
        try {
            if (OrderData.existsOrderByItemCode(selectedItem.getCode())){
                new Alert(Alert.AlertType.ERROR, "Failed to delete, the item already associated with an order").show();
            }else{
                ItemData.deleteItem(selectedItem.getCode());
