...
import lk.ijse.dep11.leon_pos.tm.Item;
...
public class PlaceOrderFormController {
    ...
    private void newOrder() throws IOException {
        ...
        try {
            ...
            cmbCustomerId.getItems().addAll(CustomerData.getAllCustomer());
            cmbItemCode.getItems().clear();
            cmbItemCode.getItems().addAll(ItemData.getAllItems());
            String lastOrderId = OrderData.getLastOrderId();
            if (lastOrderId == null){
    ...
    public void btnPlaceOrderOnAction(ActionEvent actionEvent) throws IOException {
        try {
            OrderData.saveOrder(lblId.getText().replace("Order ID: ", "").strip(),
    ...
    private void printBill(){
        try {
            JasperDesign jasperDesign = JRXmlLoader
                    .load(getClass().getResourceAsStream("/print/leon-pos-bill.jrxml"));
